...
public interface IngredientMapper {
    final String getRandom = "select ingredient.IngredientLink,ingredient.IngredientName from ingredient right join requiredmaterials on ingredient.IngredientNumber = requiredmaterials.IngredientNumber right join\n" +
